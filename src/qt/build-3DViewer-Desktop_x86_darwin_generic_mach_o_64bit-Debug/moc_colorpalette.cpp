...
#include <memory>
#include "../3DViewer/colorpalette.h"
...
void ColorPalette::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->Color((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorPalette::Color)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ColorPalette::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorPalette::clicked)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<ColorPalette, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QColor, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void ColorPalette::Color(QColor _t1)
{
