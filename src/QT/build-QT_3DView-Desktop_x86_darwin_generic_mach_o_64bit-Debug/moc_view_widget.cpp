...
#include <memory>
#include "../QT_3DView/view_widget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_view_widget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_view_widget_t qt_meta_stringdata_view_widget = {
    {
QT_MOC_LITERAL(0, 11) // "view_widget"
...
const QMetaObject view_widget::staticMetaObject = { {
    ...
    qt_meta_stringdata_view_widget.offsetsAndSize,
    qt_meta_data_view_widget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_view_widget_t
, QtPrivate::TypeAndForceComplete<view_widget, std::true_type>
